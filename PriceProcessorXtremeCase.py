...
class PriceProcessorXtremeCase:
    def __init__(self, markup_value=200, price_col_index=4, header_row=5, output_subdir="processed_files"):
        """
...
if __name__ == "__main__":
    processor = PriceProcessorXtremeCase(markup_value=200, price_col_index=4, header_row=5)
